        ...
        def m_unified_selector(label, guide, key):
            ...
            if aplica:
                ...
                with c2:
                    ...
                    p3 = st.text_input("P3. ¿Por qué ocurrió lo descrito en el punto 2?", key=f"p3_{key}")
                    p4 = st.text_input("P4. ¿Por qué ocurrió lo descrito en el punto 3?", key=f"p4_{key}")
