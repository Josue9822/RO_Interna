        ...
        def m_unified_selector(label, guide, key):
            ...
            if aplica:
                ...
                with c2:
                    ...
                    p1 = st.text_input("P1. ¿Por qué ocurrió el problema?", key=f"p1_{key}", placeholder="Causa directa...", height=100)
                    p2 = st.text_input("P2. ¿Por qué ocurrió lo descrito en el punto 1?", key=f"p2_{key}", height=100)
                    p3 = st.text_input("P3. ¿Por qué ocurrió lo descrito en el punto 2?", key=f"p3_{key}", height=100)
                    p4 = st.text_input("P4. ¿Por qué ocurrió lo descrito en el punto 3?", key=f"p4_{key}", height=100)
